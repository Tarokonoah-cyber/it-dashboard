...
export function matchLocalIntent(message) {
  ...
  if (wantsCompleteWork(normalized)) {
    return {
      reply: "\u76ee\u524d\u5de5\u4f5c\u7d00\u9304\u6c92\u6709\u5b89\u5168\u5b8c\u6210\u72c0\u614b\u66f4\u65b0 API\uff0c\u56e0\u6b64\u6211\u6c92\u6709\u4fee\u6539\u8cc7\u6599\u3002",
      action: inferCompleteWorkItem(message)
    };
  }
  ...
  if (wantsExplicitTodo(normalized)) {
  ...
  if (wantsCalendar(normalized)) {
    return {
      reply: "calendar_unavailable",
      action: inferCalendarUnavailable(message)
    };
  }
